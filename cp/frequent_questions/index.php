                                ...
                                <div class="table_wrap">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo dictionary('TYPE');?></th>
                                            <th style="width: 150px;"><?php echo dictionary('STATUS');?></th>
                                        ...
                                        foreach ($get_table_info as $table_info)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="<?php echo dictionary('TYPE');?>">
                                                    <?php
                                                    $faq_section_data = $db
                                                        ->where('id', $table_info['faq_section_id'])
                                                        ->getOne('faq_sections');
                                                    if($faq_section_data)
                                                    {
                                                        echo "<span style='color: #004da2;'>".$faq_section_data['title_'.$lang]."</span>";
                                                    }
                                                    ?>
                                                </td>
