$(document).ready(function() {
    $(function() {
        ...
        var e = window.location,
            ...
            }).addClass("active").parent().parent().addClass("in").parent().addClass("selected");
        i.is("li") && i.addClass("active")
    }), $(function() {
        $(window).bind("load resize", function() {
            width = this.window.innerWidth > 0 ? this.window.innerWidth : this.screen.width, width < 1170 ? ($("body").addClass("content-wrapper"), $(".open-close i").removeClass("icon-arrow-left-circle"), $(".sidebar-nav, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), $("#side-menu span.hide-menu").css("display", "none"), $(".sidebar .fa-fw").css("position", "relative"), $(".logo span").hide()) : ($("body").removeClass("content-wrapper"), $(".open-close i").addClass("icon-arrow-left-circle"),  $("#side-menu span.hide-menu").css("display", "block"), $(".sidebar .fa-fw").css("position", "absolute"), $(".logo span").show())
        })
    }), $(".open-close").on("click", function() {
        $("body").hasClass("content-wrapper") ? ($("body").trigger("resize"), $(".sidebar-nav, .slimScrollDiv").css("overflow", "hidden").parent().css("overflow", "visible"), $("body").removeClass("content-wrapper"), $(".open-close i").addClass("icon-arrow-left-circle"), $("#side-menu span.hide-menu").css("display", "block"), $(".sidebar .fa-fw").css("position", "absolute"), $(".logo span").show()) : ($("body").trigger("resize"), $(".sidebar-nav, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), $("body").addClass("content-wrapper"), $(".open-close i").removeClass("icon-arrow-left-circle"), $("#side-menu span.hide-menu").css("display", "none"), $(".sidebar .fa-fw").css("position", "relative"), $(".logo span").hide())
    }),
        function(e, i, s) {
