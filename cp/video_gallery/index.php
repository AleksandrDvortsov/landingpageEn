                            ...
                            <div class="wrapper">
                                <div class="table_wrap">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th><?php echo dictionary('SORT');?></th>
                                        ...
                                        foreach ($get_table_info as $table_info)
                                        {
                                            ?>
                                            <tr>
                                                <td data-label="<?php echo dictionary('SORT');?>"><?php echo $table_info['sort'];?></td>
                                                <td data-label="<?php echo dictionary('TITLE');?>"><?php echo $table_info['video'];?></td>
