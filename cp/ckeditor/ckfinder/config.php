...
in CKFinder. If empty, the default value (/ckeditor_files/) is used.

Examples:
	$baseUrl = 'http://example.com/ckfinder/files/';
	$baseUrl = '/ckeditor_files/';

ATTENTION: The trailing slash is required.
*/
$baseUrl = '/uploads/ckeditor_files/';
...
Examples:
	...
	$baseDir = 'C:/SiteDir/CKFinder/ckeditor_files/';
