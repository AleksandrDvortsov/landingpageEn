                        ...
                        <div class="white-box">
                            ...
                            if ( $catalog_id == 0 )
                            {
                                ...
                                <div class="label label-info label-rounded" style="float: right;">
                                    <a style="color:white;font-size: 14px;" href="<?php echo $Cpu->getURL(518);?>?section_id=<?=$catalog_id?>">
                            ...
                            if ( $catalog_id > 0 )
                            {
                                ?>
                                <div class="label label-info label-rounded" style="float: right;">
                                    <a style="color:white;font-size: 14px;" href="<?php echo $Cpu->getURL(521);?>?section_id=<?=$catalog_id?>">
                                                ...
                                                foreach ($get_subcatalog_list as $subcatalog_list)
                                                {
                                                    ...
                                                    <tr  <?php if($subcatalog_list['active'] == 0 ) { ?> class="inactive_element" <?php } ?>>
                                                        ...
                                                        <td class="table_td_a_button no_background">
                                                            <a href="<?php echo $Cpu->getURL(517); ?>?section_id=<?php echo $subcatalog_list['id'] ?>">
                                                                <button class="view_button" type="button" title="View"></button>
                                                            </a>
                                                            <a href="<?php echo $Cpu->getURL(519);?>?section_id=<?php echo $subcatalog_list['id'] ?>">
                                                                <button class="edit_button" type="button" title="Edit"></button>
                                                            </a>
                                                            <a href="<?php echo $Cpu->getURL(520);?>?section_id=<?php echo $subcatalog_list['id'] ?>"
                                            ...
                                            <table class="table">
                                                ...
                                                foreach ($get_subcatalog_list as $subcatalog_list)
                                                {
                                                    ...
                                                    <tr  <?php if($subcatalog_list['active'] == 0 ) { ?> class="inactive_element" <?php } ?>>
                                                        ...
                                                        <td class="table_td_a_button no_background">
                                                            <a href="<?php echo $Cpu->getURL(522);?>?section_id=<?php echo $catalog_id;?>&id=<?php echo $subcatalog_list['id']?>">
                                                                <button class="edit_button" type="button" title="Edit"></button>
                                                            </a>
                                                            <a href="<?php echo $Cpu->getURL(523);?>?id=<?php echo $subcatalog_list['id'] ?>"
