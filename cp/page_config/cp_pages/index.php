...
if($User->check_cp_authorization())
{
    if($User->access_control($client_access)) {
                        ...
                        <div class="white-box">
                            <form class="form-material form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" onkeyup="search_cp_pages(this.value)"    value="">
                                    </div>
                                </div>
                            </form>
                            ...
                            if($User->access_control($developer_access))
                            {
                                ...
                                <div class="label label-info label-rounded" style="float: right;">
                                    <a style="color:white;font-size: 14px;" href="<?php echo $Cpu->getURL(16);?>">
        ...
        <script>
            function search_cp_pages(search_value)
            {
                var data = {};
                data['task'] = 'search_cp_pages';
