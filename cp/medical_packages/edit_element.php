    ...
    if($User->access_control($Form->page_access($page_data['id'])))
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            foreach ($list_of_site_langs as $site_langs)
            {
                ...
                $data_list['design_for_'.$site_langs] = $db->escape($ar_post_clean['design_for_'.$site_langs]);
                $data_list['duration_'.$site_langs] = $db->escape($ar_post_clean['duration_'.$site_langs]);
                                            ...
                                            <div id="item_description">
                                                ...
                                                foreach( $list_of_site_langs as $lang_index )
                                                {
                                                    ...
                                                    <div class="t<?php echo $c_tab++?> tab_content">
                                                        ...
                                                        $Form->edit_title($element['design_for_'.$lang_index], 'design_for_'.$lang_index, 0, dictionary('FRONT_CP_DESIGN_FOR'));
                                                        $Form->edit_title($element['duration_'.$lang_index], 'duration_'.$lang_index, 0, dictionary('FRONT_CP_DURATION'));
