        ...
        <div class="row">
            <div class="fusion-layout-column fusion_builder_column fusion_builder_column_3_5  fusion-three-fifth fusion-column-last 3_5">
                ...
                <div class="fusion-column-wrapper fusion-column-price-right"
                    ...
                    {
                        ?>
                        <div class="fusion-title title fusion-sep-none fusion-title-center fusion-title-size-one doctor-title fusion-border-below-title dev_a8b"
                    ...
                    {
                        ?>
                        <div class="fusion-title-single-center fusion-title title fusion-sep-none fusion-title-center fusion-title-size-one doctor-title fusion-border-below-title dev_a8b"
                             style="margin-top:0px;margin-bottom:0px;">
                            <div class="title-heading-center dev_ab2" data-fontsize="30" data-lineheight="36">
                                <span style="color: #fff;"><?php echo $element['title_'.$lang];?></span>
                            </div>
                    ...
                    <div class="imageframe-align-center">
                            <span class="fusion-imageframe imageframe-none imageframe-1 hover-type-none doctor-image">
                                <?php
                                $elemnt_image_thumb = $Functions->image_thumb($element['image'], 'medical_packages', 1200, 770, 112, 0);
                                ?>
                ...
                <div class="fusion-column-text dev__editor">
